...
export interface ezcloud {
   ...
   * @public
   */
  queryGetFirstOne: (inputs: QueryGetFirstOne) => { [key: string]: any };
  /** 
   ...
   * @public
   */
  uploadMedia: ({ url }: { url?: string | undefined }) => any;
  /** 
...
export interface context {
   ...
   */
  getArg: (
    inputArgName: string | "fz_callback_body" | "fz_payment_callback_input"
  ) => any;
  /** 
